...
define LINUX_INSTALL_DTB_SDCARD
	...
	cp $(addprefix \
		...
		$(SDCARD_DIR)
endef
define LINUX_INSTALL_DTB_BOOTFILES
	# dtbs moved from arch/<ARCH>/boot to arch/<ARCH>/boot/dts since 3.8-rc1
	cp $(addprefix \
		$(KERNEL_ARCH_PATH)/boot/$(if $(wildcard \
		$(addprefix $(KERNEL_ARCH_PATH)/boot/dts/,$(KERNEL_DTBS))),dts/),$(KERNEL_DTBS)) \
...
define LINUX_INSTALL_KERNEL_IMAGE_TO_SDCARD
	install -m 0644 -D $(LINUX_IMAGE_PATH) $(SDCARD_DIR)/$(BR2_LINUX_KERNEL_INSTALL_SDCARD_NAME)
	$(LINUX_INSTALL_DTB_SDCARD)
endef
endif

define LINUX_INSTALL_KERNEL_IMAGE_TO_BOOTFILES
	install -m 0644 -D $(LINUX_IMAGE_PATH) $(BOOTFILES_DIR)/$(BR2_LINUX_KERNEL_INSTALL_SDCARD_NAME)
	$(LINUX_INSTALL_DTB_BOOTFILES)
endef
...
define LINUX_INSTALL_TARGET_CMDS
	...
	$(LINUX_INSTALL_KERNEL_IMAGE_TO_BOOTFILES)
