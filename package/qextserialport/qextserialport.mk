...
define QEXTSERIALPORT_INSTALL_TARGET_CMDS
	$(QEXTSERIALPORT_FAKEROOT) $(QEXTSERIALPORT_FAKEROOT_ENV) $(INSTALL) -d -m 0755 $(QEXTSERIALPORT_TARGET_DIR)/usr/lib
	$(QEXTSERIALPORT_FAKEROOT) $(QEXTSERIALPORT_FAKEROOT_ENV) cp -a $(@D)/*.so.* $(QEXTSERIALPORT_TARGET_DIR)/usr/lib
endef
