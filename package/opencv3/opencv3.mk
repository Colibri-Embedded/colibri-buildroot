...
OPENCV3_CONF_OPTS += \
	...
	-DPYTHON2_INCLUDE_DIR:PATH=$(STAGING_DIR)/usr/include/python$(PYTHON_VERSION_MAJOR) \
...
OPENCV3_CONF_OPTS += \
	...
	-DPYTHON3_INCLUDE_DIR:PATH=$(STAGING_DIR)/usr/include/python$(PYTHON3_VERSION_MAJOR)m \
	-DPYTHON3_LIBRARY=$(STAGING_DIR)/usr/lib/libpython$(PYTHON3_VERSION_MAJOR)m.so \
...
OPENCV3_CONF_OPTS += \
	-DBUILD_opencv_python2=OFF \
	-DBUILD_opencv_python3=OFF
#BR2_PACKAGE_OPENCV3_LIB_PYTHON
endif 


# Installation hooks:
define OPENCV3_CLEAN_INSTALL_DOC
	$(OPENCV3_FAKEROOT) rm -fr $(OPENCV3_TARGET_DIR)/usr/share/OpenCV/doc
endef
OPENCV3_POST_INSTALL_TARGET_HOOKS += OPENCV3_CLEAN_INSTALL_DOC

define OPENCV3_CLEAN_INSTALL_CMAKE
	$(OPENCV3_FAKEROOT) rm -f $(OPENCV3_TARGET_DIR)/usr/share/OpenCV/OpenCVConfig*.cmake
endef
...
define OPENCV3_CLEAN_INSTALL_DATA
	$(OPENCV3_FAKEROOT) rm -fr $(OPENCV3_TARGET_DIR)/usr/share/OpenCV/haarcascades \
		$(OPENCV3_TARGET_DIR)/usr/share/OpenCV/lbpcascades
endef
