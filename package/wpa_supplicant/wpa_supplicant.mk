...
define WPA_SUPPLICANT_INSTALL_WPA_CLIENT_SO
	$(WPA_SUPPLICANT_FAKEROOT) $(INSTALL) -m 0644 -D $(@D)/$(WPA_SUPPLICANT_SUBDIR)/libwpa_client.so \
		$(WPA_SUPPLICANT_TARGET_DIR)/usr/lib/libwpa_client.so
	$(WPA_SUPPLICANT_FAKEROOT) $(INSTALL) -m 0644 -D $(@D)/src/common/wpa_ctrl.h \
		$(WPA_SUPPLICANT_TARGET_DIR)/usr/include/wpa_ctrl.h
endef
...
define WPA_SUPPLICANT_INSTALL_IFUPDOWN
...
define WPA_SUPPLICANT_INSTALL_CONF
...
define WPA_SUPPLICANT_INSTALL_TARGET_CMDS
	...
	$(WPA_SUPPLICANT_INSTALL_CONF)
	$(WPA_SUPPLICANT_INSTALL_IFUPDOWN)
