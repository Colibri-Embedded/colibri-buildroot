...
LINUX_FUSION_ETC_DIR = $(LINUX_FUSION_TARGET_DIR)/etc/udev/rules.d
...
LINUX_FUSION_MAKE_OPTS += SYSROOT=$(LINUX_FUSION_TARGET_DIR)
...
define LINUX_FUSION_INSTALL_TARGET_CMDS
	$(TARGET_CONFIGURE_OPTS) $(MAKE) \
		...
		INSTALL_MOD_PATH=$(LINUX_FUSION_TARGET_DIR) \
		-C $(@D) install
