...
define GETTEXT_REMOVE_UNNEEDED
	$(GETTEXT_FAKEROOT) $(GETTEXT_FAKEROOT_ENV) $(RM) -rf $(GETTEXT_TARGET_DIR)/usr/share/gettext/ABOUT-NLS
	$(GETTEXT_FAKEROOT) $(GETTEXT_FAKEROOT_ENV) rmdir --ignore-fail-on-non-empty $(GETTEXT_TARGET_DIR)/usr/share/gettext
endef
