...
define BCACHE_TOOLS_CREATE_MISSING_DIRS
	$(INSTALL) -m 0755 -d $(BCACHE_TOOLS_TARGET_DIR)/usr/share/man/man8
	$(INSTALL) -m 0755 -d $(BCACHE_TOOLS_TARGET_DIR)/lib/udev/rules.d
endef
...
define BCACHE_TOOLS_INSTALL_TARGET_CMDS
	$(TARGET_MAKE_ENV) $(TARGET_CONFIGURE_OPTS) $(MAKE) -C $(@D) \
		DESTDIR=$(BCACHE_TOOLS_TARGET_DIR) install
endef
