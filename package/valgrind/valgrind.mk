...
define VALGRIND_INSTALL_UCLIBC_SUPP
	$(INSTALL) -D -m 0644 package/valgrind/uclibc.supp $(VALGRIND_TARGET_DIR)/usr/lib/valgrind/uclibc.supp
endef
...
define VALGRIND_REMOVE_MEMCHECK
	rm -f $(VALGRIND_TARGET_DIR)/usr/lib/valgrind/*memcheck*
endef
...
define VALGRIND_REMOVE_CACHEGRIND
	rm -f $(VALGRIND_TARGET_DIR)/usr/lib/valgrind/*cachegrind*
	for i in cg_annotate cg_diff cg_merge; do \
		rm -f $(VALGRIND_TARGET_DIR)/usr/bin/$$i ; \
	done
endef
...
define VALGRIND_REMOVE_CALLGRIND
	rm -f $(VALGRIND_TARGET_DIR)/usr/lib/valgrind/*callgrind*
...
define VALGRIND_REMOVE_HELGRIND
	rm -f $(VALGRIND_TARGET_DIR)/usr/lib/valgrind/*helgrind*
endef
...
define VALGRIND_REMOVE_DRD
	rm -f $(VALGRIND_TARGET_DIR)/usr/lib/valgrind/*drd*
endef
...
define VALGRIND_REMOVE_MASSIF
	rm -f $(VALGRIND_TARGET_DIR)/usr/lib/valgrind/*massif*
	rm -f $(VALGRIND_TARGET_DIR)/usr/bin/ms_script
endef
...
define VALGRIND_REMOVE_DHAT
	rm -f $(VALGRIND_TARGET_DIR)/usr/lib/valgrind/*dhat*
endef
...
define VALGRIND_REMOVE_PTRCHECK
	rm -f $(VALGRIND_TARGET_DIR)/usr/lib/valgrind/*ptrcheck*
endef
...
define VALGRIND_REMOVE_BBV
	rm -f $(VALGRIND_TARGET_DIR)/usr/lib/valgrind/*bbv*
endef
...
define VALGRIND_REMOVE_LACKEY
	rm -f $(VALGRIND_TARGET_DIR)/usr/lib/valgrind/*lackey*
endef
...
define VALGRIND_REMOVE_NULGRIND
	rm -f $(VALGRIND_TARGET_DIR)/usr/lib/valgrind/*none*
endef
