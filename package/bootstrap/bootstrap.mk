...
define BOOTSTRAP_INSTALL_TARGET_CMDS
	$(INSTALL) -m 0644 -D $(@D)/dist/css/bootstrap-theme.min.css \
		$(BOOTSTRAP_TARGET_DIR)/var/www/bootstrap/css/bootstrap-theme.min.css
	$(INSTALL) -m 0644 -D $(@D)/dist/css/bootstrap.min.css \
		$(BOOTSTRAP_TARGET_DIR)/var/www/bootstrap/css/bootstrap.min.css
	$(INSTALL) -m 0644 -D $(@D)/dist/js/bootstrap.min.js \
		$(BOOTSTRAP_TARGET_DIR)/var/www/bootstrap/js/bootstrap.min.js
	cp -r $(@D)/dist/fonts $(BOOTSTRAP_TARGET_DIR)/var/www/bootstrap/
endef
