...
define RPI_USERLAND_INSTALL_INIT_SYSV
	$(INSTALL) -m 0755 -D package/rpi-userland/S94vcfiled \
		$(RPI_USERLAND_TARGET_DIR)/etc/init.d/S94vcfiled
endef
endif

define RPI_USERLAND_POST_TARGET_CLEANUP
	rm -f $(RPI_USERLAND_TARGET_DIR)/etc/init.d/vcfiled
	rm -f $(RPI_USERLAND_TARGET_DIR)/usr/share/install/vcfiled
	rmdir --ignore-fail-on-non-empty $(RPI_USERLAND_TARGET_DIR)/usr/share/install
	rm -Rf $(RPI_USERLAND_TARGET_DIR)/usr/src
endef
