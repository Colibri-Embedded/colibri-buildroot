...
define JQUERY_UI_THEMES_INSTALL_TARGET_CMDS
	$(INSTALL) -m 0644 -D \
		...
		$(JQUERY_UI_THEMES_TARGET_DIR)/var/www/jquery-ui.css
	$(INSTALL) -d $(JQUERY_UI_THEMES_TARGET_DIR)/var/www/images
	cp -a $(@D)/themes/$(call qstrip,$(BR2_PACKAGE_JQUERY_UI_THEMES_THEME))/images/*.png \
		$(JQUERY_UI_THEMES_TARGET_DIR)/var/www/images
	chmod 0644 $(JQUERY_UI_THEMES_TARGET_DIR)/var/www/images/*.png
endef
